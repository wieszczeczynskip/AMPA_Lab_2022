...
private const val ARG_1 = "0"
private const val ARG_PARAM2 = "param2"

/**
 * A simple [Fragment] subclass.
 * Use the [Image1Fragment.newInstance] factory method to
...
class Image1Fragment : Fragment() {
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(param1: Int) = Image1Fragment().apply { arguments = Bundle().apply { putInt(ARG_1, param1) } }
    }
}